    ...
    <main class="main">
        ...
        <table class="tableProduto">
            <thead>
                <!-- Barra Titulo -->
                <tr>
                    <td class="barTitulo barTituloProduto">Lista de Produtos</td>
                </tr>
                <!-- Barra Botão Incluir -->
                <tr>
                    <td class="barButton barButtonProduto">
                        <button type="button" class="btnAdd" onClick="goPage('formCadProduto.php?codigo=0');"><i class="fa fa-plus"></i> Incluir</button>
                    </td>
                </tr>
                <!-- Cabeçalho Colunas -->
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="regBranco regBrancoProduto">
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td class="textRight"><?php echo $dados['valor']; ?></td>
                            <td class="textRight"><?php echo $dados['quantidade']; ?></td>
                            <td class="td-action">
                                <button type="button" class="btnEdit" title="Editar" onClick="goPage('formCadProduto.php?codigo=<?php echo $dados['codigo']; ?>');"><i class="fa fa-edit"></i></button>
                                <button type="button" class="btnDel" title="Excluir" onClick="showDialogExclusao(dialogExclusao,'Tem certeza que deseja excluir esse registro?','<?php echo $dados['codigo']; ?>','backend/produtos_del.php','listProdutos.php');"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                <?php
                    }
