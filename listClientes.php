<?php
    ...
    if(!isset($_GET['codMsg']) || $_GET['codMsg']<>3){
        $sql = "SELECT clientes.codigo,clientes.nome,clientes.cpf,telefones.numero AS 'telefone',enderecos.cidade,enderecos.estado FROM clientes LEFT JOIN telefones ON clientes.codigo=telefones.clienteId LEFT JOIN enderecos ON clientes.codigo=enderecos.clienteId ORDER BY nome";
...
<body>
    ...
    <header class="header">
        ...
        <div class="icon icon-menu" id="menutop" onClick="goPage('menu.php');">
    ...
    <main class="main">
        ...
        <table class="tableCliente">
            <thead>
                <!-- Barra Titulo -->
                <tr>
                    <td class="barTitulo barTituloCliente">Lista de Clientes</td>
                </tr>
                <!-- Barra Botão Incluir -->
                <tr>
                    <td class="barButton barButtonCliente">
                        <button type="button" class="btnAdd" onClick="goPage('formCadCliente.php?codigo=0');"><i class="fa fa-plus"></i> Incluir</button>
                    </td>
                </tr>
                <!-- Cabeçalho Colunas -->
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="regBranco regBrancoCliente">
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td class="textRight"><?php echo $dados['cpf']; ?></td>
                            <td class="textRight"><?php echo $dados['telefone']; ?></td>
                            <td><?php echo $dados['cidade']; ?></td>
                            <td><?php echo $dados['estado']; ?></td>
                            <td class="td-action">
                                <button type="button" class="btnEdit" title="Editar" onClick="goPage('formCadCliente.php?codigo=<?php echo $dados['codigo']; ?>');"><i class="fa fa-edit"></i></button>
                                <button type="button" class="btnDel" title="Excluir" onClick="showDialogExclusao(dialogExclusao,'Tem certeza que deseja excluir esse registro?','<?php echo $dados['codigo']; ?>','backend/clientes_del.php','listClientes.php');"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                <?php
                    }
